...
void replaceInFile(String path) {
  ...
  final badShareRowText = 'Text("₹", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: color)),';
  final goodShareRowText = 'Text("₹\${amount.toStringAsFixed(amount == amount.truncateToDouble() ? 0 : 2)}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: color)),';
  ...
  final regex = RegExp(r'Text\("[^"]+", style: TextStyle\(fontWeight: FontWeight.bold, fontSize: 14, color: color\)\),');
