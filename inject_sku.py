...
files = ['lib/screens/ceo_dashboard.dart', 'lib/screens/cofounder_dashboard.dart']
...
for path in files:
    ...
    target = "                      const Divider(color: Colors.black26),"
    
    if "2026 SKU Tracker" not in content:
        content = content.replace(target, sku_tracker_code + target)
