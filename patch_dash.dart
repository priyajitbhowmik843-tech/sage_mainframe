            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: _showMainPoolShares ? Colors.white12 : const Color(0xFFF4F6F0), borderRadius: BorderRadius.circular(10), border: Border.all(color: _showMainPoolShares ? Colors.white24 : Colors.black, width: 1.5)),
                  alignment: Alignment.centerLeft,
                  child: FractionallySizedBox(widthFactor: state.mainPool.income > 0 ? (state.mainPool.netBalance / state.mainPool.income).clamp(0.0, 1.0) : 0.0, child: Container(decoration: BoxDecoration(color: const Color(0xFFE2E8CE), borderRadius: BorderRadius.circular(8)))),
                ),
                AnimatedCrossFade(
                  duration: const Duration(milliseconds: 300),
                  ...
                  secondChild: Builder(
                    builder: (context) {
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Row(children: [Container(padding: const EdgeInsets.all(6), decoration: BoxDecoration(color: color.withOpacity(0.2), borderRadius: BorderRadius.circular(8)), child: Icon(icon, color: color, size: 14)), const SizedBox(width: 8), Text(name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.black87))]),
                                  Text("₹\", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: color)),
                                ],
                              ),
                              const SizedBox(height: 6),
                              Container(height: 6, width: double.infinity, decoration: BoxDecoration(color: Colors.black12, borderRadius: BorderRadius.circular(4)), alignment: Alignment.centerLeft, child: FractionallySizedBox(widthFactor: total > 0 ? (amount / total).clamp(0.0, 1.0) : 0.0, child: Container(decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(4))))),
                            ],
                          ),
                        );
                      }
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const SizedBox(height: 16), const Divider(color: Colors.black12),
          ...
          child: AnimatedContainer(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text("VIDEO PRODUCTION POOL", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.black54)),
                            const SizedBox(width: 6),
                            AnimatedRotation(turns: _showVideoPoolShares ? 0.5 : 0, duration: const Duration(milliseconds: 300), child: const Icon(Icons.keyboard_arrow_down, size: 16, color: Colors.black54)),
                          ],
                        ),
                      ],
                    ),
                ...
                Container(
                  height: 6, width: double.infinity,
                  decoration: BoxDecoration(color: _showVideoPoolShares ? Colors.white12 : const Color(0xFFF4F6F0), borderRadius: BorderRadius.circular(10), border: Border.all(color: _showVideoPoolShares ? Colors.white24 : Colors.black, width: 1.5)),
                  alignment: Alignment.centerLeft,
                  child: FractionallySizedBox(widthFactor: state.videoPool.income > 0 ? (state.videoPool.netBalance / state.videoPool.income).clamp(0.0, 1.0) : 0.0, child: Container(decoration: BoxDecoration(color: const Color(0xFFE2E8CE), borderRadius: BorderRadius.circular(8)))),
                ),
                AnimatedCrossFade(
                  duration: const Duration(milliseconds: 300),
...
''';
    ...
    print('Could not find replace string in ' + path);
  }
}
