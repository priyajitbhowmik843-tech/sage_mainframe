...
class SageCalendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final startOffset = DateTime(currentMonth.year, currentMonth.month, 1).weekday % 7;
        ...
        children: [
          customHeader ?? Row(
            ...
            children: [
              ...
              Text('${months[currentMonth.month-1]} ${currentMonth.year}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 1)),
              GestureDetector(
                onTap: onNextMonth,
                child: Container(
                  width: 32, height: 32,
          ...
          GridView.builder(
            ...
            gridDelegate: gridDelegate ?? const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 7, childAspectRatio: 1),
...
Widget calendarLegend(Color c, String label) => Row(children: [
