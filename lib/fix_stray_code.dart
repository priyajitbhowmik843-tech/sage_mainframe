...
void main() {
  ...
  final startRegex = RegExp(r'\s*Text\(statusText, style: TextStyle\(fontSize: 10, color: statusColor, fontWeight: FontWeight\.bold, letterSpacing: 0\.5\)\),');
  final endRegex = RegExp(r'        \}\)\.toList\(\),\r?\n      \),\r?\n    \);\r?\n  \}');
