...
void main() {
  ...
  // 2. Paid Till fix
  if (content.contains('final displaySessions = emp.paymentCleared ? (emp.pendingPayMonth ?? "\$unpaidSessionsCount") : "\\\$unpaidSessionsCount";')) {
    final videoInsert = '''
...
''';
    content = content.replaceFirst('final displaySessions = emp.paymentCleared ? (emp.pendingPayMonth ?? "\$unpaidSessionsCount") : "\\\$unpaidSessionsCount";', videoInsert);
