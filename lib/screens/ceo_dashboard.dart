                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (isGraphicsEditor) ...[
                        Text(
                          "PER DESIGN RATE: \u20B9${employee.perDesignRate.toStringAsFixed(0)}",
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ...
                        Text(
                          "UNPAID DESIGNS: $unpaidDesignsCount",
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Colors.black87,
                        ...
                        Text(
                          "PENDING PAYOUT: \u20B9${pendingDesignPayout.toStringAsFixed(0)}",
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Colors.black87,
                              ...
                              Column(
                                ...
                                children: [
                                  DropdownButtonFormField<String>(
                                    ...
                                    decoration: const InputDecoration(
                                      labelText: "Select Graphics Editor",
                                    ),
                                    dropdownColor: Colors.white,
                                    items: [
                                      const DropdownMenuItem(
                                        value: 'COF-RIT-001',
                                        child: Text("CFO Ritam"),
                                      ),
                                      ...state.employees
                                          .where(
                                            (e) =>
                                                e.hasRole('graphic') ||
                                                e.name.toLowerCase().contains('subhajit'),
                                          )
                                          .map(
                                            (e) => DropdownMenuItem(
                                              value: e.id,
