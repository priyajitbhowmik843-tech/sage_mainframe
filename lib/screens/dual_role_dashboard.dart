                    ...
                    Expanded(
                      child: PageView(
                        ...
                        children: [
                          ...
                          const ClientResourcesScreen(readOnly: true),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (holiday != null && dayTasks.isEmpty) Padding(padding: const EdgeInsets.symmetric(horizontal: 2.0), child: Text(holiday, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 8, color: textColor, fontWeight: FontWeight.bold, height: 1.1))),
                    ],
                  ),
                ),
              );
