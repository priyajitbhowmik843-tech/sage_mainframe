...
void main() {
  ...
  if (!t.contains('void _showAddMemberDialog(BuildContext context) {}')) {
    t = t.replaceAll('  Widget _buildTeamTab() {', '  void _showAddMemberDialog(BuildContext context) {}\n  void _showAddLedgerDialog(BuildContext context) {}\n\n  Widget _buildTeamTab() {');
  }
  ...
  t = t.replaceAll('selectedDate: _selectedDate,', 'selectedDate: _selectedDate!,');
  File(p).writeAsStringSync(t);
