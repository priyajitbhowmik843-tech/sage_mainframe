...
void main() {
  ...
  if (!stateContent.contains('acknowledgeVideographerPayment')) {
    int approveIdx = stateContent.indexOf('void approveVideographerSession(String taskId)');
    if (approveIdx != -1) {
      String newMethod = '''
...
''';
      stateContent = stateContent.substring(0, approveIdx) + newMethod + stateContent.substring(approveIdx);
