const fs = require('fs');
const p = 'C:/Users/Priyajit Bhowmik/Downloads/n sage os/sage os/sage os/sage_mainframe/lib/screens/ceo_dashboard.dart';
let t = fs.readFileSync(p, 'utf8');

// 1. Add preferredName display to Persona accordion (around line 1356, inside children)
t = t.replace(
...
console.log('Updated ceo_dashboard.dart personnel dialogs and persona view');
