...
void main() {
  ...
  for (var filePath in filesToEdit) {
    ...
    final regex = RegExp(r'Center\(\s*child: Container\(\s*width: 140, height: 140,.*?child: ClipOval\(child: Image\.asset\((.*?), fit: BoxFit\.cover, width: 88, height: 88\)\),\s*\),\s*\),', multiLine: true, dotAll: true);
