          ...
          children: [
            ...
            Expanded(
              child: DashboardTile(
                title: "Finances",
                subtitle:
                    "Γé╣${state.netBalance.toStringAsFixed(0)}\nControl your revenue",
      ...
      child: ListView(
        ...
        children: [
          if (pendingClients.isNotEmpty) ...[
            Text(
              "CLIENTS DUE (Γé╣${totalClientsDue.toStringAsFixed(0)})",
              style: const TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 10,
                color: SageColors.primary,
              ...
              (c) => Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "Γé╣${c.totalAmountDue.toStringAsFixed(0)} (${c.dynamicPaymentsDue} mo)",
                      style: const TextStyle(
                        fontSize: 12,
                        color: SageColors.error,
                        fontWeight: FontWeight.bold,
                        ...
                        rows: logs.map((log) {
                          ...
                          return DataRow(
                            cells: [
                              ...
                              DataCell(Text("Γé╣${amount.toStringAsFixed(0)}")),
                            ],
                          );
                        }).toList(),
                      ),
                  ...
                  children: [
                    ...
                    if (c.isTerminationRequested)
                      ...
                      const Padding(
                        padding: EdgeInsets.only(top: 8.0),
                        child: Text(
                          "├óΓé¼┬ó Requested Conversion to Active Client",
                          style: TextStyle(
                            color: Colors.green,
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                ...
                children: [
                  ...
                  if (_clientSubTab == 'ACTIVE' ||
                    ...
                    if (c.isWebsiteHandlingActive)
                      _buildClientDetailRow(
                        "Website Handling",
                        "Γé╣${c.websiteHandlingFee.toStringAsFixed(0)}",
                      ),
                    c.ecomPaymentType == 'Per SKU'
                        ? _buildClientDetailRow(
                            "Base Monthly Fee",
                            "Γé╣${c.getPayableForMonth(DateTime.now().month, DateTime.now().year).toStringAsFixed(0)} (Actual varies by SKU logs)",
                          )
                        : _buildClientDetailRow(
                            "Monthly Fee",
                            "Γé╣${(c.monthlyPayable + (c.isWebsiteHandlingActive ? c.websiteHandlingFee : 0)).toStringAsFixed(0)}",
                          ),
                    ...
                    if (c.assignedVideographerId != null &&
                      ...
                      _buildClientDetailRow(
                        "Session Rate",
                        "Γé╣${c.sessionRate.toStringAsFixed(0)}",
                      ),
                    ],
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (totalSkus > 0)
                                    Text(
                                      "Γé╣${totalForMonth.toStringAsFixed(0)}",
                                      style: const TextStyle(
                                        fontSize: 8,
                                        color: Colors.black54,
                                        fontWeight: FontWeight.bold,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isVideo) ...[
                        Text(
                          "PENDING SESSION PAYOUT: Γé╣${pendingSessionPayout.toStringAsFixed(0)}",
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      if (isVideoEditorPerVideo) ...[
                        Text(
                          "PENDING VIDEO PAYOUT: Γé╣${pendingVideoPayout.toStringAsFixed(0)}",
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      if (!isVideo &&
                        ...
                        if (isME) ...[
                          ...
                          Text(
                            "SALARY: Γé╣${employee.monthlySalary.toStringAsFixed(0)} / mo",
                            style: const TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.bold,
                              color: Colors.black,
                                    ...
                                    children: [
                                      if (existingSessionsOnDate >= 3)
                                        Container(
                                          ...
                                          child: const Text(
                                            "ΓÇó Max 3 clients already booked on this date.",
                                            style: TextStyle(
                                              color: Colors.red,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 12,
                                            ...
                                            return CheckboxListTile(
                                              ...
                                              title: Text(
                                                _sessionVideographerId ==
                                                        'COF-PRI-001'
                                                    ? c.name
                                                    : "${c.name} - Γé╣${c.sessionRate.toStringAsFixed(0)}/session",
                                                style: const TextStyle(
                                                  fontSize: 12,
                                                ),
                                              ),
                    ...
                    if (localServiceType.toLowerCase().contains(
                      ...
                      if (localEcomPaymentType == 'Per SKU') ...[
                        ...
                        SageTextField(
                          ...
                          label: "Per SKU Rate (Γé╣)",
                          keyboardType: TextInputType.number,
                        ),
                        const SizedBox(height: 10),
                        SageTextField(
                          controller: _clientDuplicateSkuRateCtrl,
                          label: "Per Duplicate SKU Rate (Γé╣)",
                          keyboardType: TextInputType.number,
                        ),
                        const SizedBox(height: 10),
                        SageTextField(
                          controller: _clientCatalogueRateCtrl,
                          label: "Per Catalogue Rate (Γé╣)",
                          keyboardType: TextInputType.number,
                        ),
                      ],
                    ],
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "Γé╣${(amount == amount.truncateToDouble() ? amount.toStringAsFixed(0) : amount.toStringAsFixed(2))}",
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14,
                                          color: color,
        ...
        Row(
          children: [
            Expanded(
              child: StatChip(
                label: "INFLOW",
                value: "Γé╣${state.totalIncome.toStringAsFixed(0)}",
            ...
            Expanded(
              child: StatChip(
                label: "OUTFLOW",
                value: "Γé╣${state.totalExpenses.toStringAsFixed(0)}",
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      Text(
                        "${f.isIncome ? '+' : '-'}Γé╣${f.amount.toStringAsFixed(0)}",
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: f.isIncome
                              ? SageColors.primary
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        if (f.discount > 0)
                          buildDetailChip(
                            "Discount",
                            "Γé╣${f.discount.toStringAsFixed(0)}",
                          ),
              ...
              child: Column(
                children: [
                  ...
                  SageTextField(
                    ...
                    label: "Fixed Monthly Salary (Γé╣)",
                    keyboardType: TextInputType.number,
                  ),
                  const SizedBox(height: 10),
                  SageTextField(
                    controller: rateCtrl1,
                    label: "Per Video/Reel Rate (Γé╣)",
                    keyboardType: TextInputType.number,
                  ),
                  const SizedBox(height: 10),
                  SageTextField(
                    controller: rateCtrl2,
                    label: "Per Session Rate (Γé╣)",
                    keyboardType: TextInputType.number,
                  ),
                  const SizedBox(height: 10),
                  SageTextField(
