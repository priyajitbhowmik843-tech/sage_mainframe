...
void main() async {
  ...
  final newFetchFunc = '''  Future<void> _fetchGoogleHolidays() async {
...
$mapContent      };
  ...
  final ceoRegex = RegExp(r'  Future<void> _fetchGoogleHolidays\(\) async \{.*?if \(mounted\) setState\(\(\) => _isLoadingHolidays = false\);\s*\}', dotAll: true);
  ...
  final cofRegex = RegExp(r'  Future<void> _fetchGoogleHolidays\(\) async \{.*?if \(mounted\) setState\(\(\) => _isLoadingHolidays = false\);\s*\}', dotAll: true);
  ...
  final dualRegex = RegExp(r'    final _googleHolidays = <String, String>\{.*?\};', dotAll: true);
  final dualMapReplacement = '    final _googleHolidays = <String, String>{\n$mapContent    };';
