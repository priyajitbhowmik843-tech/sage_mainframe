...
const filepath = path.join(__dirname, 'lib', 'screens', 'cofounder_dashboard.dart');
let content = fs.readFileSync(filepath, 'utf8').replace(/\r\n/g, '\n');

const startMarker = '        // Main balance box with purple visual\n        Container(';
const endMarker = '        const SizedBox(height: 14),\n\n        // Income / Expenses Stat Grid';
...
'                      children: [',
'                        Text(',
'                          "' + INR + '${state.netBalance.toStringAsFixed(0)}",',
'                          style: TextStyle(',
'                            fontSize: 34,',
...
'                AnimatedCrossFade(',
'                  duration: const Duration(milliseconds: 300),',
'                  crossFadeState: _showDetailedShares ? CrossFadeState.showSecond : CrossFadeState.showFirst,',
...
'                                    children: [',
'                                      Text("' + INR + '${amount.toStringAsFixed(0)}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: color)),',
'                                      Text("${pct.toStringAsFixed(1)}%", style: const TextStyle(fontSize: 10, color: Colors.white54)),',
'                                    ],',
'                                  ),',
'                                ],',
'                              ),',
...
console.log('Patched cofounder_dashboard.dart, length diff:', patched.length - content.length);
