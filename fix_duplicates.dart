...
void main() {
  ...
  var firstIdx = text.indexOf("  void updateClientStatus(String clientId, String status) {");
  var secondIdx = text.indexOf("  void updateClientStatus(String clientId, String status) {", firstIdx + 1);
