  ...
  void fixFile(String path) {
    ...
    for (int i = 0; i < lines.length; i++) {
      if (lines[i].contains('(\${')) {
        ...
        if (lines[i].contains('Text(\${') || lines[i].contains('Text( (\${') || lines[i].contains('value: (\${') || lines[i].contains('label: (\${') || lines[i].contains('Text((\${') || lines[i].contains('value:(\${') || lines[i].contains('Text ( (\${')) {
