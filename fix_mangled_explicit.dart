  ...
  for (final path in files) {
    ...
    for (int i = 0; i < lines.length; i++) {
      if (lines[i].contains('t.deadline.day') &&
        ...
        lines[i] =
            leadingSpaces +
            'Text("\${_getAssigneeName(t.assignedTo, state)} • \${t.deadline.day}/\${t.deadline.month}", style: TextStyle(color: Colors.red.shade700, fontSize: 10, fontWeight: FontWeight.bold)),';
        changed = true;
