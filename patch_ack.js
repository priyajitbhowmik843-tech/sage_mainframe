const fs = require('fs');
let content = fs.readFileSync('lib/state/app_state.dart', 'utf8');

const target =   void acknowledgeVideographerPayment(String taskId) {
...
const replacement =   void acknowledgeVideographerPayment(String taskId) {
    final idx = _tasks.indexWhere((t) => t.id == taskId);
    if (idx != -1) {
...
fs.writeFileSync('lib/state/app_state.dart', content);
